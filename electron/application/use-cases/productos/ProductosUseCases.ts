...
export const ProductoBaseSchema = z.object({
  ...
  precio_compra_usd: z.number().min(0).optional().default(0),
  precio_venta_usd: z.number().min(0).optional().default(0),
  precio_compra_ves: z.number().min(0).optional().default(0),
  precio_venta_ves: z.number().min(0).optional().default(0),
